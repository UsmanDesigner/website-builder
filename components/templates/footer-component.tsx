...
import { footerTemplates } from "@/lib/component-templates"
...
export function FooterComponent({ component, styles }: FooterComponentProps) {
  const template = footerTemplates.find((t) => t.id === component.template)

  if (!template) {
    return <div>Footer template not found</div>
  }
